...
POSTGRES_STATEMENTS = (
    ...
    "ALTER TABLE IF EXISTS client_result_detail ADD COLUMN IF NOT EXISTS sample_image_url TEXT",
    "ALTER TABLE IF EXISTS client_result_detail ALTER COLUMN sample_image_url TYPE TEXT",
